...
class RecommendationsGetMatchRequest(_message.Message):
...
class RecommendationsGetMatchResponse(_message.Message):
...
class RecommendationsUpdateUserRequest(_message.Message):
...
class RecommendationsUpdateUserResponse(_message.Message):
