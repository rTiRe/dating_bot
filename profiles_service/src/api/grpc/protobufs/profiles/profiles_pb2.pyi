...
class ProfileCreateRequest(_message.Message):
    __slots__ = ("account_id", "name", "age", "gender", "biography", "language_locale", "image_base64_list", "interested_in", "city_point", "user_point")
    ...
    def __init__(self, account_id: _Optional[str] = ..., name: _Optional[str] = ..., age: _Optional[int] = ..., gender: _Optional[_Union[Gender, str]] = ..., biography: _Optional[str] = ..., language_locale: _Optional[str] = ..., image_base64_list: _Optional[_Iterable[str]] = ..., interested_in: _Optional[_Union[Gender, str]] = ..., city_point: _Optional[_Union[CityPoint, _Mapping]] = ..., user_point: _Optional[_Union[UserPoint, _Mapping]] = ...) -> None: ...
...
class ProfileCreateResponse(_message.Message):
    __slots__ = ("id", "account_id", "name", "age", "gender", "biography", "language_locale", "created_at", "updated_at", "image_base64_list", "rating", "interested_in", "city_point", "user_point")
    ID_FIELD_NUMBER: _ClassVar[int]
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    AGE_FIELD_NUMBER: _ClassVar[int]
